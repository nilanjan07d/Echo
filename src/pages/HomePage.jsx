...
import blindingLights from "../assets/blinding_lights.mp3";
        ...
        <div className="flex-1">
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-4 gap-4">
              {[
                { id: "ocean-eyes-home", title: "Ocean Eyes", subtitle: "Billie Eilish", artist: "Billie Eilish", genre: "Alternative", audio: oceanEyes, image: oceaneye },
                { id: "lose-yourself-home", title: "Lose Yourself", subtitle: "Eminem", artist: "Eminem", genre: "Hip-Hop", audio: loseYourself, image: eminem },
                { id: "shape-of-you-home", title: "Shape of You", subtitle: "Ed Sheeran", artist: "Ed Sheeran", genre: "Pop", audio: shapeOfYou, image: shapeofyoued },
                { id: "heat-waves-home", title: "Heat Waves", subtitle: "Glass Animals", artist: "Glass Animals", genre: "Indie", audio: heatWaves, image: glassanimals },
                { id: "levitating-home", title: "Levitating", subtitle: "Dua Lipa", artist: "Dua Lipa", genre: "Pop", audio: levitating, image: lavitatingpic},
                { id: "starboy-home", title: "Starboy", subtitle: "The Weeknd ft. Daft Punk", artist: "The Weeknd", genre: "Pop", audio: starboy, image: starboypic },
                { id: "bad-guy-home", title: "Bad Guy", subtitle: "Billie Eilish", artist: "Billie Eilish", genre: "Alternative", audio: badGuy, image: badguypic },
                { id: "sunflower-home", title: "Sunflower", subtitle: "Post Malone & Swae Lee", artist: "Post Malone, Swae Lee", genre: "Hip-Hop", audio: sunflower, image: sunflowerpic }
              ].map((card) => (
        ...
        <div className="hidden lg:block w-80">
          <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/40 backdrop-blur-sm border border-gray-700/30 rounded-2xl p-6 h-fit">
            ...
            <div className="space-y-3">
              {[
                { id: 'shape-sidebar', title: "Shape of You", artist: "Ed Sheeran", subtitle: "Ed Sheeran", genre: "Pop", color: "from-blue-500 to-cyan-500", initials: "SY", audio: shapeOfYou },
                { id: 'badguy-sidebar', title: "Bad Guy", artist: "Billie Eilish", subtitle: "Billie Eilish", genre: "Alternative", color: "from-green-500 to-teal-500", initials: "BG", audio: badGuy },
                { id: 'sunflower-sidebar', title: "Sunflower", artist: "Post Malone & Swae Lee", subtitle: "Post Malone, Swae Lee", genre: "Hip-Hop", color: "from-indigo-500 to-purple-500", initials: "SF", audio: sunflower }
              ].map((track) => (
                <div 
                  key={track.id}
